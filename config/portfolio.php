...
return [
    ...
    'items' => [
        ...
        'cyberfind' => [
            ...
            'client'        => 'CyberFind',
            'summary'       => 'Peer-review and decision-support platform where 500+ verified CISOs compare Security Awareness Training and Human Risk Management vendors – built on Next.js and Node.js with Python services for data aggregation and review verification.',
            'industries'    => ['cybersecurity', 'saas', 'b2b'],
            'technologies'  => ['nextjs', 'nodejs', 'python'],
            'type'          => 'product',
            'case_study_url'=> '/case-studies/cyberfind/',
            'external_url'  => 'https://cyberfind.io/',
            'thumbnail'     => '/images/portfolio/cyberfind-thumb.png',
            'featured'      => true,
            'enabled'       => true,
            'order'         => 1,
        ],
        ...
        'vedic-whisper' => [
            'slug'          => 'vedic-whisper',
            'name'          => 'Vedic Whisper – AI Astrology Platform',
            'client'        => 'Vedic Whisper (India)',
            'summary'       => 'AI-powered Vedic astrology platform in Hindi and English serving 8,000+ users with Kundli analysis, Guna Milan compatibility matching and a conversational ask-anything assistant – built on Laravel with AI integrations, chat history and premium subscription tiers.',
            'industries'    => ['ai', 'wellness', 'consumer'],
            'technologies'  => ['laravel', 'mysql', 'openai'],
            'type'          => 'product',
            'case_study_url'=> null,
            'external_url'  => 'https://vedicwhisper.com/',
            'thumbnail'     => '/images/portfolio/vedic-whisper-thumb.png',
            'featured'      => false,
            'enabled'       => true,
            'order'         => 2,
        ],
        ...
        'jewelnxt' => [
            'slug'          => 'jewelnxt',
            'name'          => 'Jewel NXT – Premium Jewelry Manufacturing',
            'client'        => 'Jewel NXT',
            'summary'       => 'Premium brand website for a jewelry manufacturing and design house – a cinematic, animation-rich Next.js frontend with lookbook, certification showcase and enquiry flows built for B2B buyers and designers.',
            'industries'    => ['manufacturing', 'luxury', 'b2b'],
            'technologies'  => ['nextjs', 'react'],
            'type'          => 'project',
            'case_study_url'=> null,
            'external_url'  => 'https://jewelnxt.com/',
            'thumbnail'     => '/images/portfolio/jewelnxt-thumb.png',
            'featured'      => false,
            'enabled'       => true,
            'order'         => 3,
        ],
