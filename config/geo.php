    ...
    'washington' => [
        ...
        'sections' => [
            ...
            'proof' => [
                ...
                'cases' => [
                    [
                        'label'    => 'Snappy Stats – Scheduling web app',
                    ...
                    [
                        ...
                        'region'   => 'Belgium & neighbouring markets',
                        'headline' => 'Launched a custom hiring portal that centralises employers, vacancies and candidates for HR professionals.',
                        'result'   => 'Turned scattered CVs into a structured, searchable talent pool and shortened time-to-shortlist.',
                        'url'      => '/case-studies/bloomford/',
                    ],
                    [
                        'label'    => 'Plugin – Tennis club management web app',
                        'industry' => 'Sports / Club & Membership Management',
                        'region'   => 'Switzerland (remote collaboration)',
                        'headline' => 'Built a tennis club management and court booking web app for a Swiss club.',
                        'result'   => 'Reduced double bookings and improved visibility into court utilisation, memberships and payments.',
                        'url'      => '/case-studies/plugin/',
                    ],
                    [
                        'label'    => 'Hellory – Smart reminder app for busy lives',
                        'industry' => 'Consumer Apps / Productivity',
                        'region'   => 'India (global consumer audience)',
                        'headline' => 'Designed and shipped a cross-platform smart reminder app using Flutter and a Node.js/MongoDB backend.',
                        'result'   => 'Delivered a reliable notification pipeline and a solid foundation for future premium features.',
                ...
                'testimonials' => [
                    [
                        ...
                        'name'   => 'Founder',
                        'title'  => 'Bloomford – Hiring Portal for HR Professionals',
                        'region' => 'Belgium',
                    ],
                ],
            ],
