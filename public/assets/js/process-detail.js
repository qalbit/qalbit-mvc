(function () {
    ...
    function initMvpFaqSection(ctx) {
        ...
        // React FaqSection manages accordion + item visibility
        if (section.getAttribute("data-faq-managed") === "react") {
            return;
        }
        ...
        // Accordion behaviour — React FaqSection manages its own accordion
        if (section.getAttribute("data-faq-managed") === "react") return;
