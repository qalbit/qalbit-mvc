<?php
/**
 * Generic Service Overview (Section S2)
 *
 * Expects:
 * - $service (array) from config('services')
 *
 * Shape (recommended) in config/services.php:
 *
 * 'overview' => [
 *     'id'        => 'saas-overview',             // optional, html id
 *     'eyebrow'   => 'Overview',                  // small label above h2
 *     'title'     => 'Build, launch and scale your SaaS product',
 *     'intro'     => '1–2 sentences describing what this service covers.',
 *
 *     'left_title'  => 'Where this service fits best',
 *     'left_items'  => [
...
$sectionId   = $overview['id']        ?? 'service-overview';
...
// Columns
$leftTitle   = $overview['left_title']  ?? 'Where this service fits best';
...
>
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div
            ...
            data-service-overview-columns
        >
            <!-- Left column -->
            <article class="space-y-3" data-service-overview-left>
            ...
            <!-- Right column -->
            <article class="space-y-3" data-service-overview-right>
