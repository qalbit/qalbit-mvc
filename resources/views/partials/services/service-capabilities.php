<?php
/**
 * Generic Service Capabilities (Section S3)
 *
 * Expects:
 * - $service (array)
 *
 ...
 *     'intro'   => '1–2 lines explaining what kind of modules / flows this service covers.',
 *
 *     'items'   => [
 *         [
 ...
 *         'url'   => '/contact-us/?service=saas',       // optional CTA below grid
 *     ],
 * ]
 */
...
$sectionId = $capabilities['id']      ?? 'service-capabilities';
    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <?php if (!empty($items)): ?>
            <div
                ...
                data-service-capabilities-grid
            >
