<?php
/**
 * Generic Industry Process (Section S4)
 *
 * Expects:
 * - $industry (array)
 *
 * Recommended shape in config('industries.php'):
 *
 * 'process' => [
 ...
 *     'intro'   => '1–2 sentences about how you run this industry.',
 *
 *     'items'   => [
 *         [
 ...
 *             'icon'        => '/assets/industries/saas/step-discovery.svg', // optional
 *         ],
 *         ...
 *     ],
 *
 ...
 *         'url'   => '/contact-us/?industry=saas#discovery',
 *     ],
 * ]
 */
...
$sectionId = $process['id']      ?? 'industry-process';
$eyebrow   = $process['eyebrow'] ?? 'How we typically run this industry';
$title     = $process['title']
    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <?php else: ?>
            <p class="text-sm text-slate-600">
                We follow a simple discovery → design → build → launch process for this industry.
