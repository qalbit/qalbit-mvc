<?php
/**
 * Generic Industry Overview (Section S2)
 *
 * Expects:
 * - $industry (array) from config('industries')
 *
 * Shape (recommended) in config/industries.php:
 *
 * 'overview' => [
 *     'id'        => 'saas-overview',             // optional, html id
 *     'eyebrow'   => 'Overview',                  // small label above h2
 *     'title'     => 'Build, launch and scale your SaaS product',
 *     'intro'     => '1–2 sentences describing what this industry covers.',
 *
 *     'left_title'  => 'Where this industry fits best',
 *     'left_items'  => [
...
$serviceName = $industry['name'] ?? 'Industry';

// Safely read overview config
$overview    = $industry['overview'] ?? [];
$sectionId   = $overview['id']        ?? 'industry-overview';
...
// Columns
$leftTitle   = $overview['left_title']  ?? 'Where this industry fits best';
...
>
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div
            ...
            data-industry-overview-columns
        >
            <!-- Left column -->
            <article class="space-y-3" data-industry-overview-left>
            ...
            <!-- Right column -->
            <article class="space-y-3" data-industry-overview-right>
