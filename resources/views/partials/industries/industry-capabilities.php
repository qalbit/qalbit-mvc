<?php
/**
 * Generic Industry Capabilities (Section S3)
 *
 * Expects:
 * - $industry (array)
 *
 ...
 *     'intro'   => '1–2 lines explaining what kind of modules / flows this industry covers.',
 *
 *     'items'   => [
 *         [
 ...
 *         'url'   => '/contact-us/?industry=saas',       // optional CTA below grid
 *     ],
 * ]
 */
...
$sectionId = $capabilities['id']      ?? 'industry-capabilities';
    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <?php if (!empty($items)): ?>
            <div
                ...
                data-industry-capabilities-grid
            >
