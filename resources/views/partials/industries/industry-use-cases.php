<?php
/**
 * Generic Industry Use Cases (Section S5)
 *
 * Expects:
 * - $industry (array)
 *
 ...
 *         'url'   => '/contact-us/?industry=saas&topic=use-cases',
 *     ],
 * ]
 */
...
$useCases = $industry['use_cases'] ?? [];

$sectionId = $useCases['id']      ?? 'industry-use-cases';
$eyebrow   = $useCases['eyebrow'] ?? 'Where this industry fits best';
    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <?php else: ?>
            <p class="text-sm text-slate-600">
                This industry is usually a good fit when software is directly tied to revenue, operations
