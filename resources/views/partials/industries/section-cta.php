...
>
    ...
    <div class="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
        <p class="mb-3 inline-flex items-center rounded-full border border-sky-500/30 bg-sky-500/5 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em] text-sky-300">
            ...
            Planning industry-specific software for your business?
        </p>

        <h2 class="text-display-md sm:text-display-lg md:text-display-xl font-bold text-slate-50 mb-4">
            Turn your industry workflows into reliable software your teams actually use.
        </h2>

        <p class="mx-auto mb-8 max-w-2xl text-sm sm:text-base text-slate-300">
            Share your core processes, current tools and bottlenecks. We’ll map them into a practical roadmap for industry-grade web, mobile or internal systems.
        </p>

        <div class="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            <a
                href="/contact-us/?topic=industry-discovery"
                class="btn btn-accent btn-radius-pill"
                aria-label="Book an industry software discovery call with QalbIT"
            >
                Book an industry software discovery call
            </a>

            <a
                href="/contact-us/?topic=industry-brief&source=industries-page"
                class="btn btn-primary-outline btn-radius-pill text-sky-200 border-sky-500/50 hover:bg-slate-900"
                aria-label="Send your industry software brief and requirements to QalbIT"
            >
                Send your industry software brief
            </a>
        </div>

        <p class="mt-4 text-[11px] text-slate-400">
            We typically respond within 24–48 hours with clarifications, options and recommended next steps.
        </p>
    </div>
</section>
