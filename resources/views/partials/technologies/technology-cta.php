<?php
/**
 * Technology CTA section (S8)
 *
 * Expects:
 * - array $technology with optional 'cta' config
 */

$technology = $technology ?? [];
$cta     = $technology['cta'] ?? [];

// Allow turning CTA off per technology
$ctaEnabled = $cta['enabled'] ?? true;
if (!$ctaEnabled) {
    return;
}

$serviceName = $technology['name'] ?? 'software development';
