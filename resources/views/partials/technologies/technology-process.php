<?php
/**
 * Generic Technology Process (Section S4)
 *
 * Expects:
 * - $technology (array)
 *
 ...
 *     'intro'   => '1–2 sentences about how you run this technology.',
 *
 *     'items'   => [
 *         [
 ...
 *         'url'   => '/contact-us/?technology=saas#discovery',
 *     ],
 * ]
 */
...
$sectionId = $process['id']      ?? 'technology-process';
$eyebrow   = $process['eyebrow'] ?? 'How we typically run this technology';
$title     = $process['title']
    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <?php else: ?>
            <p class="text-sm text-slate-600">
                We follow a simple discovery → design → build → launch process for this technology.
