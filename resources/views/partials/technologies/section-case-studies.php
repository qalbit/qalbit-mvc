...
$caseStudies = [
    [
        'label'      => 'Case 01',
        'title'      => 'Plugin – CodeIgniter operations panel',
        'industry'   => 'Internal tools · Legacy modernisation',
        'summary'    => 'We stabilised and extended a CodeIgniter-based panel used to manage critical plugin operations, without disrupting existing workflows.',
        'stack_line' => 'CodeIgniter · PHP · MySQL · Legacy panel modernisation',
    ...
    [
        'label'      => 'Case 02',
        'title'      => 'SnappyState – Laravel admin panel',
        'industry'   => 'B2B SaaS · Admin dashboards',
        'summary'    => 'We delivered a Laravel-based admin panel for SnappyState to manage users, data and workflows through a clean, opinionated backend.',
        'stack_line' => 'Laravel · PHP · MySQL/PostgreSQL · REST APIs',
    ...
    [
        'label'      => 'Case 03',
        'title'      => 'Hellory – Flutter mobile application',
        'industry'   => 'Mobile apps · Customer experience',
        'summary'    => 'We built a Flutter application for Hellory to give users a smooth, cross-platform mobile experience connected to existing backend services.',
        'stack_line' => 'Flutter · Dart · REST APIs · Android & iOS',
