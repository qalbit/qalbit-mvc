<?php
/**
 * Generic Technology Use Cases (Section S5)
 *
 * Expects:
 * - $technology (array)
 *
 ...
 *         'url'   => '/contact-us/?technology=saas&topic=use-cases',
 *     ],
 * ]
 */
...
$useCases = $technology['use_cases'] ?? [];

$sectionId = $useCases['id']      ?? 'technology-use-cases';
$eyebrow   = $useCases['eyebrow'] ?? 'Where this technology fits best';
    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <?php if (!empty($items)): ?>
            <div
                ...
                data-technology-use-cases-grid
            >
                <?php
                    $position = 1;
        ...
        <?php else: ?>
            <p class="text-sm text-slate-600">
                This technology is usually a good fit when software is directly tied to revenue, operations
