<?php
/**
 * Technologies – CMS & Content Platforms section (T6)
 *
 * Expects:
 * - $items (array) list of CMS technologies, e.g. $groupedTech['cms']
 */
    ...
    <div class="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        >
            <div class="space-y-3 max-w-xl">
                ...
                <p class="text-sm sm:text-base text-slate-600">
                    From corporate sites and blogs to content hubs, we use WordPress and headless
                    setups where they make sense – and pair them with custom frontends or backends
                    when you need more than a basic theme.
                </p>
            </div>
            <p class="max-w-sm text-xs text-slate-500">
                We focus on practical CMS implementations: fast, secure and easy for non-technical
                teams to update. When your needs grow, we can extend your CMS with APIs, custom
                plugins or a separate React/Next.js frontend.
            </p>
        </div>
            ...
            >
                <?php
                    ...
                    foreach ($items as $key => $tech):
                        ...
                        $icon       = $tech['icon'] ?? null;
                        $iconAlt    = $shortName ?: 'CMS technology icon';
                    ...
                    >
                        ...
                        <div class="mt-auto space-y-2 pt-3 border-t border-slate-200">
                            ...
                            <p class="text-[11px] text-slate-500">
                                Typical use cases: marketing sites, blogs, content hubs and landing
                                pages connected to custom backends or SaaS products.
                            </p>
                        </div>
                    </article>
                <?php
        ...
        <?php else: ?>
            <p class="text-sm text-slate-600">
                Our CMS technology list is currently being updated. Please check back soon or
                <a href="/contact-us/" class="text-sky-700 underline">contact us</a>
                with your website or content requirements.
            </p>
        <?php endif; ?>
    </div>
</section>
