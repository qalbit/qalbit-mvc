    ...
    <div class="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 space-y-4 md:space-y-10">
        ...
        <nav class="text-xs font-medium text-slate-600" aria-label="Breadcrumb">
            <ol class="flex flex-wrap items-center gap-1">
                <li>
                    <a href="/" class="hover:text-sky-300 transition-colors">Home</a>
                </li>
                <li class="text-slate-9000">/</li>
                <li aria-current="page" class="text-slate-9000">
                    Services
                </li>
            </ol>
        </nav>
        ...
        <div class="grid gap-10 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] lg:items-center">
            <div class="space-y-6" data-hero-el>
                ...
                <p class="text-md font-medium text-slate-600 text-center md:text-left px-0 md:px-4 lg:px-2">
                    QalbIT helps you plan, design, build and maintain secure, scalable software across
                    web, mobile, SaaS, APIs, cloud and AI. Explore our core and specialised services
                    tailored for startups and modern businesses.
                </p>
            ...
            >
                ...
                <dl class="grid grid-cols-2 gap-x-6 gap-y-4 text-xs sm:text-sm">
                    <div class="space-y-1">
                        <dt class="text-slate-500">Core focus</dt>
                        <dd class="font-medium text-slate-900">
                            Custom software &amp; SaaS
                        </dd>
                    </div>
                    <div class="space-y-1">
                        <dt class="text-slate-500">Engagements</dt>
                        <dd class="font-medium text-slate-900">
                            Fixed scope, retainers, T&amp;M
                        </dd>
                    </div>
                    <div class="space-y-1">
                        <dt class="text-slate-500">Typical starting budget</dt>
                        <dd class="font-semibold text-accent-800">
                            Mid 4-figure to low 5-figure USD
                        </dd>
                    </div>
                    <div class="space-y-1">
                        <dt class="text-slate-500">Delivery model</dt>
                        <dd class="font-medium text-slate-900">
                            Founder-led, senior engineers
                        </dd>
                    </div>
                </dl>
                <p class="text-[11px] text-slate-500">
                    Every engagement starts with a short discovery call to understand your goals,
                    constraints and existing stack, so we can propose the right approach.
                </p>
            </div>
        </div>
    </div>
