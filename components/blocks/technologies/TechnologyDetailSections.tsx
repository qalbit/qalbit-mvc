...
import type {
  ...
  TechnologyTechStackProps,
  TechnologyUseCasesProps,
} from "@/lib/blocks/technology-mappers";

export function TechnologyHeroSection(props: TechnologyHeroProps) {
  const {
    breadcrumbLabel,
    kickerPrefix,
    kickerLabel,
      ...
      <div className="relative mx-auto max-w-6xl space-y-4 px-4 sm:px-6 md:space-y-10 lg:px-8">
        <nav className="text-xs font-medium text-slate-600" aria-label="Breadcrumb">
          <ol className="flex flex-wrap items-center gap-1">
            ...
            <li>
              <Link href="/technologies/" className="transition-colors hover:text-sky-500">Technologies</Link>
            </li>
            <li className="text-slate-400">/</li>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2" data-technology-overview-columns>
          <article className="space-y-3" data-technology-overview-left>
          ...
          <article className="space-y-3" data-technology-overview-right>
...
export function TechnologyCapabilitiesSection({
  id,
  eyebrow,
  title,
  intro,
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 sm:gap-7 md:grid-cols-2 lg:grid-cols-3" data-technology-capabilities-grid>
          {items.map((item) => {
...
export function TechnologyProcessSection({
  ...
  return (
    <section
      ...
      aria-labelledby="technology-process-heading"
      data-section-technology-process
      itemScope
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <ol className="space-y-5 sm:space-y-6" data-technology-process-steps>
          {steps.map((step) => {
...
export function TechnologyUseCasesSection({
  id,
  eyebrow,
  title,
  intro,
  ...
  return (
    <section
      ...
      aria-labelledby="technology-use-cases-heading"
      data-section-technology-use-cases
      itemScope
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <header className="mb-10 max-w-3xl space-y-3">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-sky-700">{eyebrow}</p>
          <h2
            id="technology-use-cases-heading"
            className="text-display-md font-bold text-slate-900 sm:text-display-lg md:text-display-xl"
            itemProp="name"
          >
            {title}
        ...
        <div className="grid gap-6 md:grid-cols-2" data-technology-use-cases-grid>
...
export function TechnologyTechStackSection({
  id,
  eyebrow,
  title,
  intro,
  ...
  return (
    <section
      ...
      aria-labelledby="technology-tech-stack-heading"
      data-section-technology-tech-stack
      itemScope
      itemType="https://schema.org/ItemList"
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <header className="mb-10 max-w-3xl space-y-3">
          <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-sky-300">{eyebrow}</p>
          <h2
            id="technology-tech-stack-heading"
            className="text-display-md font-bold text-slate-50 sm:text-display-lg md:text-display-xl"
            itemProp="name"
          >
            {title}
        ...
        <div className="grid gap-6 md:grid-cols-2" data-technology-tech-stack-grid>
...
export function TechnologyCtaSection({ eyebrow, title, body, primary, secondary, meta }: TechnologyCtaProps) {
  return (
    <section className="relative overflow-hidden bg-slate-950 py-16 sm:py-20 lg:py-24" data-section="technology-cta">
      <div
