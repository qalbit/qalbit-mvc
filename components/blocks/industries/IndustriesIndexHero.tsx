...
export function IndustriesIndexHero() {
  return (
    <section
      ...
      <div className="relative mx-auto max-w-6xl space-y-4 px-4 sm:px-6 md:space-y-10 lg:px-8">
        <nav className="text-xs font-medium text-slate-600" aria-label="Breadcrumb">
          <ol className="flex flex-wrap items-center gap-1">
            ...
            <li aria-current="page" className="text-slate-900">Industries</li>
          </ol>
        </nav>
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] lg:items-center">
          <div className="space-y-6" data-hero-el>
            ...
            >
              ...
              <span className="ml-2 opacity-80">Home services, SaaS, travel, fintech, healthcare &amp; more</span>
            </span>
            ...
            <div className="flex justify-center md:hidden md:justify-start">
              ...
              >
                Industry-specific web, mobile &amp; SaaS solutions
              </span>
            </div>
            ...
            <p className="px-0 text-center text-md font-medium text-slate-600 md:px-4 md:text-left lg:px-2">
              QalbIT partners with businesses across entertainment, social platforms, sports &amp; fitness,
              travel, food delivery, ecommerce, fintech, real estate, healthcare, education and corporate
              operations. We design industry-specific app development and platform solutions around your
              real workflows, not just generic templates.
            </p>

            <div className="flex flex-col items-center gap-2 md:items-start">
              <div className="flex w-full flex-col items-stretch gap-3 md:flex-row md:flex-wrap md:items-center">
                <ButtonLink href="/contact-us/?topic=industries-discovery" variant="dark">
                  Discuss your industry use case
                </ButtonLink>
                <ButtonLink href="#industry-categories" variant="primary-outline">
                  View industries by category
                </ButtonLink>
              </div>
              <p className="text-[11px] text-slate-600">
                Typically responding within <span className="font-semibold">24–48 hours</span>.
                Share your industry, current systems and what you want the software to improve.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <dl className="grid grid-cols-2 gap-x-6 gap-y-4 text-xs sm:text-sm">
              <div className="space-y-1">
                ...
                <dd className="font-medium text-slate-900">Industry-specific web, mobile &amp; SaaS solutions</dd>
              </div>
              <div className="space-y-1">
                <dt className="text-slate-500">Typical industries</dt>
                <dd className="font-medium text-slate-900">
                  Home services, travel, sports &amp; fitness, fintech, ecommerce
                </dd>
              </div>
              <div className="space-y-1">
                <dt className="text-slate-500">Project types</dt>
                <dd className="font-medium text-slate-900">
                  Platforms, marketplaces, management systems, mobile apps
                </dd>
              </div>
              <div className="space-y-1">
                <dt className="text-slate-500">How we engage</dt>
                <dd className="font-medium text-slate-900">
                  Discovery, MVP, modernisation &amp; long-term support
                </dd>
              </div>
            </dl>
            <p className="text-[11px] text-slate-500">
              We start by understanding your industry, current tools and operational constraints. Then we
              design a practical roadmap for industry-specific app development and platform work that fits
              your stage, budget and internal team capacity.
            </p>
          </div>
        </div>
      </div>
