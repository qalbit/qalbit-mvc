...
export function ServiceHeroSection(props: ServiceHeroProps) {
  const {
      ...
      <div className="relative mx-auto max-w-6xl space-y-4 px-4 sm:px-6 md:space-y-10 lg:px-8">
        <nav className="text-xs font-medium text-slate-600" aria-label="Breadcrumb">
          <ol className="flex flex-wrap items-center gap-1">
            ...
            <li>
              <Link href={breadcrumbParent.href} className="transition-colors hover:text-sky-500">
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)] lg:items-center">
          <div className="space-y-6" data-hero-el>
            ...
            <div className="flex flex-col items-center gap-2 md:items-start">
              ...
              <p className="mt-1 text-[11px] text-slate-600">
                Typically responding within <span className="font-semibold">24–48 hours</span>. Share your
                current product stage, tech stack and timelines.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-[11px] text-slate-500">
              We typically start with a short discovery to understand your goals, constraints, existing
              stack and timelines – then propose a practical roadmap across architecture, UX and delivery.
            </p>
          </aside>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2" data-service-overview-columns>
          <article className="space-y-3" data-service-overview-left>
          ...
          <article className="space-y-3" data-service-overview-right>
...
export function ServiceCapabilitiesSection({
  ...
  return (
    <section
      ...
      data-section-service-capabilities
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <header className="mb-10 max-w-3xl space-y-3">
        ...
        <div className="grid gap-6 sm:gap-7 md:grid-cols-2 lg:grid-cols-3" data-service-capabilities-grid>
          {items.map((item) => {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <ol className="space-y-5 sm:space-y-6" data-service-process-steps>
          {steps.map((step) => {
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2" data-service-use-cases-grid>
...
export function ServiceTechStackSection({
  id,
  eyebrow,
  title,
  intro,
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-6 md:grid-cols-2" data-service-tech-stack-grid>
...
export function ServiceCtaSection({ eyebrow, title, body, primary, secondary, meta }: ServiceCtaProps) {
  return (
    <section className="relative overflow-hidden bg-slate-950 py-16 sm:py-20 lg:py-24" data-section="service-cta">
      <div
